                ...
                <div className="bg-white rounded-lg border border-gray-200 p-2 md:p-6 w-full lg:w-2/3">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md font-normal text-base ${errors.title ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                        />
                    ...
                    {/* Excerpt */}
                    <div className="mb-4">
                        <label htmlFor="excerpt" className="block text-sm text-gray-700 mb-1">Excerpt</label>
                        <textarea
                            id="excerpt"
                            name="excerpt"
                            rows={3}
                            ...
                            className={`w-full px-3 py-2 border rounded-md font-normal text-base ${errors.excerpt ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                        />
                    ...
                    {/* Content */}
                    <div className="mb-6">
                        <label htmlFor="content" className="block text-sm text-gray-700 mb-1">Content</label>
                        ...
                        <p className="mt-2 text-xs text-gray-500">Use the formatting toolbar to style your content.</p>
                    </div>
                        ...
                        <div className={`border rounded-md p-6 flex flex-col items-center justify-center text-center ${errors.featuredImage ? 'border-red-500' : 'border-gray-300'}`}>
                            {imagePreview ? (
                                <div className="w-full relative">
                                    <img src={imagePreview} alt="Featured" className="max-h-64 mx-auto object-contain" />
                                    <button
                                        type="button"
                            ...
                            <label className="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-md cursor-pointer hover:bg-gray-700 mt-2">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-2 md:p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <select
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-3 py-2 border rounded-md ${errors.category ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                            >
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2 border rounded-md ${errors.tags ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                            />
                        ...
                        <div className="mb-4">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border rounded-md ${errors.readTime ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                                />
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-2 md:p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2 border rounded-md ${errors.seoTitle ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
                            />
                            {errors.seoTitle && <p className="mt-1 text-sm text-red-600">{errors.seoTitle}</p>}
                        </div>

                        {/* Additional SEO inputs can go here */}
                    </div>
                </div>
            </form>
        </div>
